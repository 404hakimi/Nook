...
/**
 * {@link XrayConfigApi} 实现; 从 xray 共享配置 + 线路机拼接入连接参数.
 *
 * @author nook
 */
@Service
public class XrayConfigApiImpl implements XrayConfigApi {
    ...
    public Map<String, XrayInboundDTO> listInboundByServerIds(Collection<String> serverIds) {
        ...
        for (Map.Entry<String, XrayConfigDO> entry : cfgMap.entrySet()) {
            XrayConfigDO cfg = entry.getValue();
