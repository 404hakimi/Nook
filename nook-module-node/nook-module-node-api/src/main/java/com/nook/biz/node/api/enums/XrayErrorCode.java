...
public enum XrayErrorCode implements ErrorCode {
    ...
    /** server 客户数已达 capacity.client_max_count 上限, 不能再开新客户 */
    TOUCHDOWN_LIMIT_REACHED(6012, "server %s 客户数已达上限 %s, 不能再开通新客户"),
    ...
    /** 重装 xray 时 clientMaxCount 缩到比当前已用客户数还小, 拒绝缩容 */
    TOUCHDOWN_SHRINK_BLOCKED(6016, "server %s 缩容受阻: 当前已用 %s 个客户 > 新上限 %s, 请先 revoke 多余客户再重装"),
