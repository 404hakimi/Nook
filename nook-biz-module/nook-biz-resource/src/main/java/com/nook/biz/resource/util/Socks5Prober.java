package com.nook.biz.resource.util;
...
/**
 * 通过 SOCKS5 拨号一个公网 echo-IP 服务, 拿到出网真实 IP。零第三方依赖, 走 JDK 原生 HttpURLConnection。
 *
...
public class Socks5Prober {
    ...
    /**
     * 通过给定 SOCKS5 拨号 ECHO_URL, 返回出网公网 IP。
     * 任何异常都抛出, 调用方决定 success / error 语义。
     */
    public String probeExitIp(String socksHost, int socksPort, String socksUser, String socksPass) throws Exception {
