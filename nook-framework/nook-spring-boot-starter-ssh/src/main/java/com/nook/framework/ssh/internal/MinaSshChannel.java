...
class MinaSshChannel implements SshChannel {

    private final SessionCredential cred;
    private final ClientSession clientSession;

    @Override
    public SshExecResult exec(String cmd) {
    ...
    public SshExecResult exec(String cmd, Duration timeout) {
        ...
        try (ChannelExec ch = clientSession.createExecChannel(cmd)) {
            ...
            if (exit == null || exit != 0) {
                throw new BusinessException(SshErrorCode.SSH_COMMAND_FAILED,
    ...
    public SshExecResult execStream(String cmd, Duration timeout, Consumer<String> lineConsumer) {
        ...
        try {
            ...
            throw new BusinessException(SshErrorCode.SSH_COMMAND_FAILED, e,
